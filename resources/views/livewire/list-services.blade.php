    ...
    <div class="w-full flex items-center">
        <div class="w-full flex items-center gap-5">
            ...
            <nav class="w-full flex justify-end">
                ...
                <div>
                    <a href="{{route('add.service')}}" class=" primary-btn">
                        ...
                        <span class="breadcrumb-text">Add Service</span>
                    </a>
                </div>
            </nav>
        </div>
                            ...
                            <table class="min-w-full divide-y divide-neutral-200">
                                <thead>
                                    <tr class="text-neutral-500">
                                        ...
                                        <th class="px-3 py-3 text-xs font-medium text-left">Photo</th>
                                        <th class="px-3 py-3 text-xs font-medium text-left w-40">Title
                                        </th>
                                        <th class="px-3 py-3 text-xs font-medium text-left">Type</th>
                                        <th class="px-2 py-3 text-xs font-medium text-left">Ministered By</th>
                                        <th class="px-3 py-3 text-xs font-medium text-left">Target</th>
                                        <th class="px-3 py-3 text-xs font-medium text-left">Report</th>
                                        <th class="px-3 py-3 text-xs font-medium text-center">Date</th>
                                        <th class="px-3 py-3 text-xs font-medium text-center">Time</th>
                                        <th class="px-3 py-3 text-xs font-medium text-center">Action</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-neutral-200">
                                    ...
                                    <tr class="text-neutral-800">
                                        ...
                                        <td class="px-3 py-4 text-sm font-medium whitespace-nowrap">
                                            <img src="{{asset('storage/services/'.$service->image_url)}}" class="object-cover h-10 w-10 rounded-full" alt="">
                                        </td>
                                        <td class="px-3 py-4 text-sm whitespace-nowrap">{{$service->name}}</td>
                                        <td class="px-2 py-4 text-sm whitespace-nowrap">{{$service->type}}</td>
                                        <td class="px-3 py-4 text-sm whitespace-nowrap">{{$service->minister_name}}</td>
                                        <td class="px-3 py-4 text-sm whitespace-nowrap">{{$service->target_name}}</td>
                                        <td class="px-3 py-4 text-sm whitespace-nowrap">No</td>
                                        <td class="px-3 py-4 text-sm whitespace-nowrap">
                                            <div>
                                                <span>{{Carbon::make($service->start_date)->format('Y-m-d') }}</span> 
                                                <span>|</span><br>
                                                <span>{{Carbon::make($service->end_date)->format('Y-m-d') }}</span>
                                            </div>
                                        </td>
                                        <td class="px-3 py-4 text-sm whitespace-nowrap">
                                            <div>
                                                <span>{{Carbon::make($service->start_date)->format('g:i A') }}</span> 
                                                <span>|</span>
                                                <span>{{Carbon::make($service->end_date)->format('g:i A') }}</span>
                                            </div>
                                        </td>

                                        <td class="px-5 py-4 text-sm font-medium text-right whitespace-nowrap flex gap-2">
                                            <a href="{{Route('view.service', $service->id)}}">
                                            ...
                                            <a href="{{Route('add.service',$service->id)}}">
                                    ...
                                    @empty
                                        <tr class="w-full">
                                            <!-- <td colspan="5" class="w-full flex justify-center text-gray-600 bg-red-300">No Data</td> -->
                                        </tr>
                                    @endforelse
