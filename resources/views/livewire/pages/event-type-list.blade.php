                ...
                <ol class="inline-flex items-center mb-3 md:space-x-1 text-xs text-neutral-500 [&_.active-breadcrumb]:text-neutral-600 [&_.active-breadcrumb]:font-medium sm:mb-0">
                    ...
                    <li>
                        <a href="#_" class="inline-flex items-center px-2 py-1.5 space-x-1.5 font-normal rounded-md hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none">
                            ...
                            <span class="breadcrumb-text">Types</span>
                        </a>
                    </li>
        ...
        <div class="w-full flex justify-between">
            <div class="flex items-center gap-5">
                <div class="flex items-center gap-5 ">
                    ...
                    <span>Showing {{ $eventTypes->firstItem() }} to {{ $eventTypes->lastItem() }} of {{
                        $eventTypes->total() }}
                        entries</span>
                    @endif
                </div>
            ...
            <div>
                <a href="{{route('event.types')}}" class=" primary-btn rounded-md">
                    ...
                    <span class="breadcrumb-text">Add Type</span>
                </a>
            </div>
        </div>
        <div class="my-5">
                            ...
                            <table class="min-w-full ">
                                <thead>
                                    <tr class="text-neutral-500">
                                        ...
                                        <th class="px-5 py-3 text-xs font-medium text-left uppercase">Events Available
                                        </th>
                                ...
                                <tbody class="">
                                    ...
                                    <tr class="text-neutral-800 odd:bg-gray-100 w-full divide-x-2  divide-white">
                                        ...
                                        <td class="px-5 py-4 text-sm font-medium whitespace-nowrap flex gap-5 items-center">
                                            <input type="checkbox" name="" id="">
                                            <span>{{$type->name}}</span>
                                        </td>
                                        <td class="px-5 py-4 text-sm whitespace-nowrap">{{$type->event->count()}}
                                        </td>
                                        <td class="px-5 py-4 text-sm whitespace-nowrap">{{Carbon::make($type->created_at)->format('d M y')}}</td>
                                        ...
                                        <td class="px-5 py-4 text-sm font-medium text-right whitespace-nowrap flex justify-center gap-2">
                                            ...
                                            <a href="{{route('event.types',$type->id)}}">
