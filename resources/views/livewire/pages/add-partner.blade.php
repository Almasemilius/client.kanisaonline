<div class="space-y-5">
        ...
        <div class="w-full flex items-center gap-3 md:gap-5">
            ...
            <nav class="w-full flex justify-between items-center">
                <ol class="inline-flex items-center mb-3 md:space-x-1 text-xs text-neutral-500 [&_.active-breadcrumb]:text-neutral-600 [&_.active-breadcrumb]:font-medium sm:mb-0">
                    ...
                    <li>
                        <a href="{{route('partner.management')}}" class="inline-flex items-center md:px-2 py-1.5 space-x-1.5 font-normal rounded-md hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none">
                            <span class="breadcrumb-text">Partners & Sponsors</span>
                        </a>
                    </li>
                    <svg class="w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <g fill="none" stroke="none">
                    ...
                    <li>
                        <a href="#_" class="inline-flex items-center md:px-2 py-1.5 space-x-1.5 font-normal rounded-md hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none">
                            <span class="breadcrumb-text">Add Sponsor</span>
                        </a>
                    </li>
                </ol>
    ...
    <div class="w-full bg-white p-10">
        ...
        <div class="grid grid-cols-4 gap-10 space-y-5">
            <div class="space-y-3">
                <label for="organizer" class="font-semibold">Logo<span class="required-label">*</span></label>
                <div class="space-y-1">
                    <label wire:ignore for="dropzone-file" class="flex flex-col items-center justify-center w-full h-48 border border-gray-300 border-dashed rounded-lg cursor-pointer bg-blue-50">
                        ...
                        <input wire:model="logo" id="dropzone-file" type="file" class="hidden" />
                    </label>
            ...
            <div class="col-span-3 input-group">
                ...
                <input wire:model="sponsor.name" type="text" id="name" class="input-field w-full placeholder:text-gray-300" placeholder="Enter Sponsors name">
                <div class="w-full flex items-end">
                    <x-error-message property='sponsor.name' />
                </div>
            </div>
            <button wire:click="addSponsor" class="col-span-4 fw-full flex justify-end">
                <div>
                    <a class="w-52 primary-btn flex justify-center font-semibold">
                        ...
                        <h3 class="breadcrumb-text">Update Partner</h3>
                        @else
                        <h3 class="breadcrumb-text">Add Partner</h3>
                        @endif
                    </a>
                </div>
            </button>
