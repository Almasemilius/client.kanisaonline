                ...
                <ol class="inline-flex items-center mb-3 md:space-x-1 text-xs text-neutral-500 [&_.active-breadcrumb]:text-neutral-600 [&_.active-breadcrumb]:font-medium sm:mb-0">
                    ...
                    <li>
                        <a href="#_" class="inline-flex items-center px-2 py-1.5 space-x-1.5 font-normal rounded-md hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none">
                            ...
                            <span class="breadcrumb-text">Organizer List</span>
                        </a>
                    </li>
        ...
        <div class="w-full flex justify-between">
            <div class="flex items-center gap-5">
                <div class="flex items-center gap-5 ">
                    ...
                    <span>Showing {{ $organizers->firstItem() }} to {{ $organizers->lastItem() }} of {{
                        $organizers->total() }}
                        entries</span>
                    @endif
                </div>
            ...
            <div>
                <a href="{{route('organizers')}}"  class=" primary-btn rounded-md">
                            ...
                            <table class="min-w-full divide-y divide-neutral-200">
                                <thead>
                                    <tr class="text-neutral-500">
                                        ...
                                        <th class="px-5 py-3 w-32 text-xs font-medium text-left uppercase">Logo</th>
                                        <th class="px-5 py-3 text-xs font-medium text-left uppercase">Name</th>
                                        <th class="px-5 py-3 text-xs font-medium text-left uppercase">Phone</th>
                                        <th class="px-5 py-3 text-xs font-medium text-center uppercase">Email</th>
                                        <th class="px-5 py-3 text-xs font-medium text-center uppercase">Featured</th>
                                        <th class="px-5 py-3 text-xs font-medium text-center uppercase">Created On</th>
                                ...
                                <tbody class="divide-y divide-neutral-200">
                                    ...
                                    <tr class="text-neutral-800">
                                        ...
                                        <td class="px-5 py-4 text-sm font-medium whitespace-nowrap">
                                            <img src="{{asset('storage/organizers/'.$organizer->logo_url)}}" class="h-10 w-10" alt="">
                                        </td>
                                        <td class="px-5 py-4 text-sm whitespace-nowrap">
                                            <h1>{{$organizer->name}}</h1>
                                        </td>
                                        <td class="px-5 py-4 text-sm whitespace-nowrap">{{$organizer->phone}}</td>
                                        <td class="px-5 py-4 text-sm whitespace-nowrap">{{$organizer->email}}</td>
                                        <td class="px-5 py-4 text-sm whitespace-nowrap">
                                            <x-select :value="$organizer->isFeatured"/>
                                        </td>
                                        <td class="px-5 py-4 text-sm whitespace-nowrap">{{Carbon::make($organizer->created_at)->format('d M y')}}</td>
                                        <td class="px-5 py-4 text-sm font-medium text-right whitespace-nowrap flex justify-center gap-2">
                                            ...
                                            <a href="{{route('organizers',$organizer->id)}}">
