        ...
        <div class="w-full flex items-center gap-5">
            ...
            <nav class="w-full flex justify-between">
                ...
                <div class="flex gap-5">
                    <a href="{{route('add.member')}}" class=" primary-btn-rounded">
                        ...
                        <span class="breadcrumb-text">Add</span>
                    </a>
                    <a href="" class=" danger-btn-rounded">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 " viewBox="0 0 24 24">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m-7-7h14" />
                        </svg>
                        <span class="breadcrumb-text">Import</span>
                    </a>
                </div>
            </nav>
        </div>
